...
type RPCImpl = protobuf.RPCImpl;

export class RpcService {
  private readonly service: InstanceType<typeof Service>;

  private readonly rpcService: protobuf.rpc.Service;
  ...
  public rpcCall<TReq = any, TRes = any>(
    name: string,
    request: TReq
  ): Promise<TRes> {
