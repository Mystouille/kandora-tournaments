import { Contest as MajsoulContest } from "../../data/types/Contest";
...
export interface Contest<Id = any>
  extends
    Partial<MajsoulContest>,
    Omit<Omit<Omit<ContestPhase<Id>, "name">, "startTime">, "index"> {
  _id?: Id;
  track?: boolean;
